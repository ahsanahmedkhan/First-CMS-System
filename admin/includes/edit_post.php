...
<?php 
  ...
  if (isset($_POST['update_post'])) {
    # code...
      ...
      if (empty($post_image)) {
        $get_image = "SELECT * FROM posts WHERE post_id = $the_post_id ";
        $select_exist_image = mysqli_query($connection, $get_image);

          while($rows = mysqli_fetch_array($select_exist_image)){
      ...
      $query .="post_title = '{$post_title}', post_category_id = '{$post_category_id}', post_date = NOW(),
...
<form action="" method="Post" enctype="multipart/form-data">
  ...
  <div class="form-group">
    ...
    <label for="post_category_id">Select Category </label> <br />
